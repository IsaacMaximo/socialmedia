...
<body>
        ...
        <button>
            <div id="perfil-usuario">
                <ul id="ul-PerfildoUsuario">
                    <img src="assets/imgs/user-avatar.png" alt="IMG_error">
                    <li id="ul-perfil-usuario">
                        <ul id="ul-PerfildoUsuario-Escrita">
                            <li id="li-PerfildoUsuario-Nome">
                                <span class="UserName" id="Nome_do_Usuario">TesteNome123</span>
                            </li>

                            <li id="li-PerfildoUsuario-Arroba">
                                <span class="Texto2" id="Id_do_Usuario">@TesteNM</span>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <footer>
        <ul id="InfoMusica">
            <li><img id="Musica-Imagem" src="assets/imgs/Ellipse 1(1).png" alt=""></li>
            <li><ul>
                <li id="Musica-Nome">
                    <span class="UserName" id="Musica-Nome-span">KeepCalm</span>
                </li>
                <li id="Musica-Artista">
                    <span class="Texto2" id="Musica-Artista-span">LeandroJose</span>
                </li>
            </li></ul>
            </ul>
        <nav id="Player-Musica">

            <audio id="musica-audio" src="PARYLEAK - como a internet e a felicidade morreram e eu nem percebi.mp3"></audio>
...
<style>
    *{outline: 1px solid rgba(80, 126, 66, 0);font-weight: normal;text-transform: none;text-decoration: none;font-style: normal;box-sizing: border-box;margin: 0;padding: 0;list-style: none;text-decoration: none; font-family: "Kanit", sans-serif;font-weight: 200;font-style: normal;}
    ...
    :root {
        --preto-transparente: rgba(0, 0, 0, 0.7);
        --letraArroba: rgba(0, 0, 0, 0.5);
        --textoinfo: rgba(0, 0, 0, 0.2);
        --Texto2: rgba(45, 45, 45, 0.6);
        --aquele-azul: rgba(43, 63, 108, 0.5);
        --pesquisa: rgba(0, 0, 0, 0.85);
    }
    ...
    #itens-menu-lateral{
        ...
        gap: 20px;
        width: 230px;
        border-right: 1px solid var(--aquele-azul);
        padding: 0vw 3vh;
    }
    .TextoImportante{
        font-weight: 600;
    ...
    .ul-Aba:hover, #perfil-usuario:hover {
        background: #e0e0e0;
    ...
    #ul-PerfildoUsuario-Escrita{
        display: flex;
        flex-direction: column;
        justify-content: center;
        height: 100%;
    }
    #ul-itens-menu-lateral img{
        width: 32px;
        height: 32px;
    }
    #modo-pap, #versao {
        font-size: 14px;
        color: var(--aquele-azul);
        margin-top: 20px;
    }
    #ul-PerfildoUsuario img{
        width: 50px;
        height: 50px;
        object-fit: cover;
    }
    ...
    .BotoesMusica-Default {
        display: flex;
        align-items: center;
        gap: 15px;
    }
    
    #Player-Musica-Botao-ProgressiveBar-div {
        height: 100%;
        width: 0;
        background-color: var(--aquele-azul);
        border-radius: 2px;
        position: relative;
        transition: width 0.1s linear;
    }

    #Player-Musica-Botao-ProgressiveBar-div::before {
        content: '';
        position: absolute;
        right: -6px;
        top: 50%;
    ...
    #ProgressiveBar-container:hover #Player-Musica-Botao-ProgressiveBar-div::before {
        opacity: 1;
    }
    #Player-Musica-Botao-ProgressiveBar-ul {
        flex-grow: 1;
        max-width: 900px;
    ...
    #Player-Musica-Botao-ProgressiveBar-ul li:nth-child(2) {
        flex-grow: 1;
        min-width: 100px;
    }
    .BotoesMusica-Default-img {
        width: 30px;
        height: 30px;
        transition: transform 0.2s;
    }
    
    .MusicaBotao:hover .BotoesMusica-Default-img {
        transform: scale(1.1);
        opacity: 0.8;
    }
    #content1{
    ...
    #search-bar{
        ...
        height: 40px;
        outline: none;
        background-image: url('assets/imgs/Lupa.svg');
    ...
    #slider-div{
        ...
        border: 1px solid var(--aquele-azul);
        background-color: var(--aquele-azul);
    ...
    .MusicaBotao:hover #slider-div,
    .MusicaBotao:focus-within #slider-div {
        opacity: 1;
        visibility: visible;
    ...
    @media (max-width: 600px) {
        ...
        #Musica-Nome-span, #Musica-Artista-span {
            display: none;
        }
        
        #Player-Musica-Botao-ProgressiveBar-ul span {
            display: none;
        }
